...
2. **[Report a Bug](https://github.com/DevFrisly/YOUR-REPO-NAME/issues)**: If you believe the converter is genuinely broken, please open an issue and include the exact name and version of the modpack you are trying to convert.